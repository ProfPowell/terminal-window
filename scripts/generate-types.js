 ...
 * This script parses the source file and generates a .d.ts file
 */
...
const sourcePath = resolve(__dirname, '../src/terminal-window.js');
...
// Write the .d.ts file
const outputPath = resolve(__dirname, '../dist/terminal-window.d.ts');
